...
//
//        assertThat(notValidFields).containsOnlyKeys("country", "street");
//
//        List<String> countryErrors = notValidFields.get("country");
//        assertThat(countryErrors).hasSize(1);
//        assertThat(countryErrors).contains("length less than 4");
//
//        List<String> streetErrors = notValidFields.get("street");
//        assertThat(streetErrors).hasSize(1);
//        assertThat(streetErrors).contains("can not be null");
//    }

    @Test
    void testAdvancedValidate_withValidAddress() {
        Address address = new Address("USA", "Texas", "Main Street", "7", "2");
        Map<String, List<String>> notValidFields = Validator.advancedValidate(address);
        assertThat(notValidFields).isEmpty();
    }
    // END
}
